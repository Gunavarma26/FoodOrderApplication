        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./assert/vege.jpg" class="d-block w-75 " style="height: 350px; " alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./assert/stick.jpg" class="d-block w-75" style="height: 350px;" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./assert/burger.jpg" class="d-block w-75" style="height: 350px;" alt="...">
                </div>
            </div>
                ...
                if ($res->num_rows > 0) {
                    while ($row = $res->fetch_assoc()) {
                        ...
                        <div id="cartcont" class="col-sm-4 col-lg-3 col-md-3 text-center">
                            ...
                            <p>
                                <a href="view.php?id=' . $row['fid'] . '" class="btn btn-primary mt-auto">Add to cart</a>
                            </p>
                        </div>
                        ';
                    }
